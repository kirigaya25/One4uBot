...
KANGING_STR = [
    "Enako ijin kang yh ^_^...",
    "Pengen o(≧▽≦)o...",
    "Kamu baik deh :* ...",
    "Enako mau stickernya...",
    "Maaf kalo Enako ambil , soalnya bagus..",
    "~nyaa.",
    "chotto matte kudasai...",
    "Mou, Yamete...! Kore Ijou Watashi no Kokoro o Kegasanaide...",
    "Huft... ",
]
...
async def kang(args):
    ...
    if photo:
        ...
        await args.edit(f"`yaw ,arigatou gozaimasu`\
            \nIni koleksi sticker Enako [ayok cek](t.me/addstickers/{packname})",
                        parse_mode='md')
